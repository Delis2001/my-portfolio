...
const Footer = () => {
    return (
        <Wrapper>
            <Container>
                <p className="text-center">Designed & Built with love by Nwoye Fidelis Chidera ©{new Date().getFullYear()}</p>
                ...
                <ul role='list' className="flex">
                    ...
                    <li><a href=" https://wa.me/2348121685344" target='_blank' referrerPolicy='no-referrer' rel="noreferrer"><i className='bx bxl-whatsapp'></i></a></li>
